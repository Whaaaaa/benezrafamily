      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-4 pt-4 pb-6 sticky top-0 z-10">
        ...
        <div className="flex gap-2 mt-3">
          <Link
            ...
            target="_blank"
            className="flex items-center gap-1.5 bg-white/20 hover:bg-white/30 text-white text-xs font-semibold px-3 py-1.5 rounded-full"
          >
            <span>👁</span>
          ...
          {data.phone && (
            <a
              ...
              className="flex items-center gap-1.5 bg-green-500/80 hover:bg-green-400 text-white text-xs font-semibold px-3 py-1.5 rounded-full"
            >
